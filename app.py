...
from hyperlink import recurse, execute_bot
import webbrowser
from tkinter import *
...
def predict_symptom():
    ...
    if sentence.replace(".", "").replace("!","").lower().strip() == "done":
        if not user_symptoms:
            ...
            response_sentence = f"It looks to me like you have <b>" + disease + "</b>. <br><br> <i>Description: " + description + "</i>" + "<br><br><b>"+ precautions + "</b><br><br>" + f"Confidence level: {(confidence_level * 1000):.2f}%" + "<br>"
